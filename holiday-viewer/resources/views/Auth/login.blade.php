...
<head>
    ...
    <style>
        ...
        .login-title { color: #ff6b35; font-weight: 700; font-size: 2rem; margin-bottom: 10px; }
        .login-subtitle { color: #5cb85c; font-size: 0.95rem; margin-bottom: 30px; }
        .form-label { color: #333; font-weight: 600; font-size: 0.9rem; margin-bottom: 8px; }
        .form-control {
            border: 2px solid #e0e0e0; border-radius: 12px; padding: 12px 16px;
        ...
        .register-link { color: #5cb85c; text-decoration: none; font-weight: 600; transition: all 0.3s ease; }
        .register-link:hover { color: #4a9d4a; text-decoration: underline; }
...
<body class="d-flex align-items-center">
    <div class="container">
        <div class="login-container mx-auto">
            ...
            <p class="login-subtitle text-center">Login to continue your journey</p>
            ...
            <div class="text-center">
                <a href="{{ route('register.form') }}" class="register-link">Create an account</a>
            </div>
        </div>
    </div>
